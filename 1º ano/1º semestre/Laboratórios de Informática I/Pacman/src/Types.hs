...
-- PacState = (pacState, timeMega, openClosed, pacmanMode)
--                 =
--            PlayerState 
--                 =
--(Int, Coords, Double , Orientation, Int, Int)
--                 =
...
--Given a String and a color returns a String
{-
...
--Given a List of Players and a Maze returns a Maze
...
--Given a Player returns a String
...
--Given a Player returns a Integer
...
--Given a Player and a Coords return a Player
...
--Given a Piece returns a Orientation
...
--Given a Player returns a PacMode

getPacmanMode :: Player -> PacMode
getPacmanMode (Pacman (PacState a b c d)) = d


--Given a Player returns a PLayerState
...
--Given a Player returns a Orientation
...
--Given a Coords and a Piece and a Maze returns a Maze
...
--Given a Integer and an any element and a List  rerturns a List
...
--Given a Player returns a Coords
