...
\column{3}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{loop}\;\Varid{a}\;\Varid{b}\;\Varid{c}\mathrel{=}\conj{\conj{\Varid{coef}\;\Varid{a}\;\Varid{b}\;\Varid{c}}{\p1\comp \p1}}{\p2\comp \p1}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mathbf{where}\;\Varid{coef}\;\Varid{a}\;\Varid{b}\;\Varid{c}\;((\Varid{x},\Varid{y}),\Varid{z})\mathrel{=}\Varid{a}\mathbin{*}\Varid{x}\mathbin{+}\Varid{b}\mathbin{*}\Varid{y}\mathbin{+}\Varid{z}\mathbin{*}\Varid{c}{}\<[E]%
\\
...
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{gene}{}\<[15]%
\>[15]{}\mathrel{=}(\Varid{id}+\Varid{id}\times\Varid{f})\comp \Varid{out}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mathbf{where}{}\<[E]%
\\
\>[3]{}\hsindent{2}{}\<[5]%
\>[5]{}\Varid{f}{}\<[15]%
\>[15]{}\mathrel{=}\anaList{\Varid{geneAna}}\comp \map \;(\Varid{drop}\;\mathrm{4}){}\<[E]%
\\
\>[3]{}\hsindent{2}{}\<[5]%
\>[5]{}\Varid{geneAna}{}\<[15]%
\>[15]{}\mathrel{=}(\Varid{id}+\Varid{l})\comp \Varid{outList}{}\<[E]%
\\
\>[3]{}\hsindent{2}{}\<[5]%
\>[5]{}\Varid{l}\;(\Varid{h},\Varid{t}){}\<[15]%
\>[15]{}\mathrel{=}(\Varid{h}\mathbin{:}\Varid{take}\;(\Varid{k}\;\Varid{t})\;\Varid{t},\Varid{drop}\;(\Varid{k}\;\Varid{t})\;\Varid{t}){}\<[E]%
\\
\>[3]{}\hsindent{2}{}\<[5]%
\>[5]{}\Varid{k}{}\<[15]%
\>[15]{}\mathrel{=}\llparenthesis\, \alt{\underline{\mathrm{0}}}{\Varid{h}}\,\rrparenthesis{}\<[E]%
\\
\>[3]{}\hsindent{2}{}\<[5]%
\>[5]{}\Varid{h}\;(\Varid{c},\Varid{ls}){}\<[15]%
\>[15]{}\mathrel{=}\mathbf{if}\;\Varid{take}\;\mathrm{1}\;\Varid{c}\equiv \text{\ttfamily \char34 ~\char34}\;\mathbf{then}\;\mathrm{1}\mathbin{+}\Varid{ls}\;\mathbf{else}\;\mathrm{0}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{post}{}\<[15]%
\>[15]{}\mathrel{=}\llparenthesis\, \alt{\Varid{g1}}{\Varid{g2}}\,\rrparenthesis_\textit{\tiny Exp}\;\mathbf{where}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{g1}{}\<[15]%
\>[15]{}\mathrel{=}\Varid{singl}\comp \Varid{singl}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{g2}\;(\Varid{h},\Varid{resto})\mathrel{=}[\mskip1.5mu [\mskip1.5mu \Varid{h}\mskip1.5mu]\mskip1.5mu]\mathbin{+\!\!\!+}(\map \;(\Varid{h}\mathbin{:})\;(\Varid{concL}\;(\Varid{resto}))){}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{concL}{}\<[15]%
\>[15]{}\mathrel{=}\llparenthesis\, \alt{\Varid{nil}}{\mathsf{conc}}\,\rrparenthesis{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\begin{eqnarray*}
\xymatrix{
  {\ensuremath{\Conid{Exp}\;\Conid{S}\;\Conid{S}}}\ar[d]^{\ensuremath{\Varid{post}}}\ar[rr]^{\ensuremath{\mathsf{out}_{\tiny\ \textit{Exp}}}} & & S + S \times (Exp S S)^*\ar[d]^{id + id \times post^*} \\
  {(S^*)^*} & & S + S \times {(S^*)^*}\ar[ll]^{\ensuremath{[\mskip1.5mu \Varid{g1},\Varid{g2}\mskip1.5mu]}}
}
\end{eqnarray*}
...
\begin{eqnarray*}
\xymatrix{
  {(S^*)^*}\ar[d]^{\ensuremath{\Varid{concL}}}\ar[rr]^{\ensuremath{\Varid{outList}}} & & 1 + (S^*) \times (S^*)^*\ar[d]^{id + id \times concL^*} \\
  {(S^*)}& & 1 + (S^*) \times {(S^*)^*}\ar[ll]^{\ensuremath{[\mskip1.5mu \Varid{nil},\mathsf{conc}\mskip1.5mu]}}
}
\end{eqnarray*}
\subsection*{Problema 3}
\begin{hscode}\SaveRestoreHook
...
\\[\blanklineskip]%
\>[B]{}\Varid{gsq}\;(\Varid{sq},\mathrm{0})\mathrel{=}(\Varid{principal}\;\Varid{sq},[\mskip1.5mu \mskip1.5mu]){}\<[E]%
\\
\>[B]{}\Varid{gsq}\;(\Varid{sq},\Varid{n})\mathrel{=}(\Varid{principal}\;\Varid{sq},\Varid{zip}\;(\Varid{divide}\;\Varid{sq})\;(\Varid{replicate}\;\mathrm{8}\;(\Varid{n}\mathbin{-}\mathrm{1}))){}\<[E]%
\\
\>[B]{}\Varid{principal}\mathbin{::}\Conid{Square}\to \Conid{Square}{}\<[E]%
\\
\>[B]{}\Varid{principal}\;((\Varid{x},\Varid{y}),\Varid{s})\mathrel{=}\mathbf{let}\;\Varid{sq}\mathrel{=}{}\<[33]%
\>[33]{}\Varid{s}\mathbin{/}\mathrm{3}\;\mathbf{in}\;((\Varid{x}\mathbin{+}\Varid{sq},\Varid{y}\mathbin{+}\Varid{sq}),\Varid{sq}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{divide}\mathbin{::}\Conid{Square}\to [\mskip1.5mu \Conid{Square}\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{divide}\;((\Varid{x},\Varid{y}),\Varid{s})\mathrel{=}[\mskip1.5mu ((\Varid{x}\mathbin{+}\Varid{i}\mathbin{*}\Varid{s}\mathbin{/}\mathrm{3},\Varid{y}\mathbin{+}\Varid{j}\mathbin{*}\Varid{s}\mathbin{/}\mathrm{3}),\Varid{s}\mathbin{/}\mathrm{3})\mid \Varid{i}\leftarrow [\mskip1.5mu \mathrm{0}\mathinner{\ldotp\ldotp}\mathrm{2}\mskip1.5mu],\Varid{j}\leftarrow [\mskip1.5mu \mathrm{0}\mathinner{\ldotp\ldotp}\mathrm{2}\mskip1.5mu],\neg \;(\Varid{i}\equiv \mathrm{1}\mathrel{\wedge}\Varid{j}\equiv \mathrm{1})\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  divide os squares evitando o principal i==1 && j==1}{}\<[E]%
\\[\blanklineskip]%
...
\\[\blanklineskip]%
\>[B]{}\Varid{carpets}\mathrel{=}\anaList{\Varid{gcarpets}}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{gcarpets}\mathrel{=}(\Varid{id}+{}\<[21]%
\>[21]{}\conj{\Varid{f}}{\Varid{id}})\comp \Varid{outNat}{}\<[E]%
\\
\>[B]{}\hsindent{10}{}\<[10]%
\>[10]{}\mathbf{where}\;\Varid{f}\;\Varid{a}\mathrel{=}{}\<[23]%
\>[23]{}\Varid{sierpinski}\;(((\mathrm{0},\mathrm{0}),\mathrm{32}),\Varid{a}){}\<[E]%
\\[\blanklineskip]%
...
\\
\>[B]{}\hsindent{9}{}\<[9]%
\>[9]{}\Varid{present}\;\Varid{t}{}\<[E]%
\\
\>[B]{}\hsindent{9}{}\<[9]%
\>[9]{}\Varid{drawSq}\;\Varid{h}{}\<[E]%
\\
\>[B]{}\hsindent{9}{}\<[9]%
\>[9]{}\Varid{await}{}\<[E]%
\\
\>[B]{}\hsindent{9}{}\<[9]%
\>[9]{}\Varid{return}\;[\mskip1.5mu ()\mskip1.5mu]{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\xymatrix{
  ...
  {Square \times Int}\ar[rr]_{\ensuremath{\Varid{gsq}}}\ar[u]^{\ensuremath{\Varid{squares}}} && {Square \times (Square\times Int)^*}\ar[u]_{id \times squares^*}
}
\end{eqnarray*}
...
\begin{eqnarray*}
\xymatrix{
  {\ensuremath{\Conid{Rose}\;\Conid{Square}}}\ar[d]^{\ensuremath{\Varid{rose2List}}}\ar[rr]^{\ensuremath{\Varid{outRose}}} & & Square \times (\ensuremath{\Conid{Rose}\;\Conid{Square}})^*\ar[d]^{id \times (rose2List)^*} \\
...
\begin{eqnarray*}
\xymatrix{
  {Square \times Int}\ar[rr]_{\ensuremath{\Varid{gsq}}}\ar[d]^{\ensuremath{\Varid{squares}}} && {Square \times (Square\times Int)^*}\ar[d]_{id \times squares^*}\\
  {\ensuremath{\Conid{Rose}\;\Conid{Square}}}\ar[d]_{\ensuremath{\Varid{rose2List}}}\ar@/_1.5pc/[rr]_{\ensuremath{\Varid{outRose}}} & & Square \times (\ensuremath{\Conid{Rose}\;\Conid{Square}})^*\ar[d]_{id \times (rose2List)^*}\ar@/_1.5pc/[ll]_{\ensuremath{\Varid{inRose}}}\\
  {Square^*}& & Square \times (Square^*)^*\ar[ll]^{cons.(id \times concat)} 
}
\end{eqnarray*}
...
\begin{eqnarray*}
\xymatrix{
  {(Square^*)^*} & & 1+ Square^* \times (Square^*)^*\ar[ll]_{\ensuremath{\Varid{inList}}} \\
  {Int}\ar[rr]_{\ensuremath{\Varid{gcarpets}}}\ar[u]^{\ensuremath{\Varid{carpets}}} && {1 + Square^* \times Int}\ar[u]_{id + id \times carpets^*}
}
\end{eqnarray*}
